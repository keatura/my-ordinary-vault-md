...
**STR: 11(0), DEX: 18(+3), CON: 16(+3), INT: 12(+1), WIS: 15(+2), CHA: 19(+4)**
**Skills:** [Persuasion] +6, [Deception] +10, [Stealth] +7, [Acrobatics] +6, [Perception] +5
**Resistances:** bludgeoning, piercing, slashing, radiant
...
**Swipe.** Marckus may use one Legendary Action make one attack with either of the profiles on his Feyblood Dagger.

**Desperate Healing.** Marckus uses two Legendary Actions to cast Vampiric Touch for free on one creature within range of the spell. This spell only lasts for the reaction, and does not require concentration. If he is already concentrating on this spell, then he makes another attack with it using this.